...
import com.example.trivia.TriviaQuestionArt
import com.example.trivia.TriviaResponseArt
...
class Science : AppCompatActivity() {
    ...
    private fun fetchJson() {
        val url = "https://opentdb.com/api.php?amount=10&category=17&type=multiple"
