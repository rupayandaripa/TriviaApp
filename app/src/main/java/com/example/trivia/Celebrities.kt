...
// celebrities api https://opentdb.com/api.php?amount=10&category=26&type=multiple
...
class Celebrities : AppCompatActivity() {
    ...
    private fun fetchJson() {
        val url = "https://opentdb.com/api.php?amount=10&category=26&type=multiple"
